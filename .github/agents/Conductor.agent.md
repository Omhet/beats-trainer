...
3. **Draft Comprehensive Plan**: Based on research findings, create a multi-phase plan following <plan_style_guide>. The plan should have 3-10 phases.
...
- Provide the specific phase number, objective, and files/functions
...
- Instruct to verify implementation correctness and code quality
